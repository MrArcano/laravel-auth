...
@section('content')
    <div class="project">
        <h1 class="text-center mb-5">Admin Project</h1>
            ...
            <tbody>
                @foreach ($projects as $project)
                    <tr>
                        ...
                        <td>
                            <a href="{{route('admin.project.show',$project)}}"><i class="fa-solid fa-eye"></i></a>
                            ...
                            <form class="d-inline-block" action="{{ route('admin.project.destroy', $project)}}" method="post" onsubmit="return confirm('Sei sicuro di voler eliminare -> {{ $project->name }} ?')">
                                @csrf
                                @method('DELETE')
                                <button class="btn-custom" type="submit"><i class="fa-solid fa-trash-can"></i></button>
                            </form>
                        </td>
                    </tr>
                @endforeach
